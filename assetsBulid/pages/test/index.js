    ...
    var Component = function (_React$Component) {
        ...
        _createClass(Component, [{
            ...
            value: function render() {
                ...
                return React.createElement("section", { className: 'page-home' }, React.createElement("h2", null, "简单例子1"), React.createElement("div", null, React.createElement("a", { onClick: this.btnClick.bind(this), className: 'ant-btn' }, "点我")), React.createElement("div", null, this.state.text), React.createElement(Component2, { text2: state.text2 }));
            }
        }]);
