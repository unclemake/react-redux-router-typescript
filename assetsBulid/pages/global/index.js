...
define("pages/global/index.js", function (require, exports, module) {
    ...
    var AppRouter = function (_React$Component2) {
        ...
        _createClass(AppRouter, [{
            key: "render",
            value: function render() {
                return React.createElement(react_router_1.Router, { history: react_router_1.hashHistory }, React.createElement(react_router_1.Redirect, { from: "/", to: "/home" }), React.createElement(react_router_1.Route, { path: "/home", getComponents: async('../home/index') }), React.createElement(react_router_1.Route, { path: "/my", getComponents: async('../my/index') }), React.createElement(react_router_1.Route, { path: "*", getComponents: async('../error/index') }));
            }
        }]);
