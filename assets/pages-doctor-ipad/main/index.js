...
class AppRouter extends React.Component {
    render() {
        return React.createElement(react_router_1.Router, {history: react_router_1.hashHistory}, React.createElement(react_router_1.Redirect, {from: "/", to: "home"}), React.createElement(react_router_1.Route, {path: "/home", getComponents: async('../home/index')}), React.createElement(react_router_1.Route, {path: "/archives", getComponents: async('../archives/index')}), React.createElement(react_router_1.Route, {path: "/inspectlist", getComponents: async('../inspectlist/index')}), React.createElement(react_router_1.Route, {path: "/userlist", getComponents: async('../userlist/index')}));
    }
}
