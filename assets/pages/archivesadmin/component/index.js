...
class App extends React.Component {
    ...
    renderList() {
        const { state, dispatch } = this.props;
        return React.createElement("section", {className: "orderadmin-page"}, React.createElement("section", {className: "seach-box"}, React.createElement("input", {className: "tc", type: "text", placeholder: "输入标签名"}), React.createElement("a", {className: "iconfont icon-seach seach-btn"}), React.createElement("div", {className: "number"}, "分组标签  3/10")), React.createElement("section", {className: "orderadmin-content"}, React.createElement("table", {className: "table"}, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null, "ID"), React.createElement("th", null, "姓名"), React.createElement("th", null, "证件类型"), React.createElement("th", null, "证件号"), React.createElement("th", null, "支付方式"), React.createElement("th", null, "就诊时间"), React.createElement("th", null, "操作"))), React.createElement("tbody", null, state.orderUserList.map((value, index) => {
