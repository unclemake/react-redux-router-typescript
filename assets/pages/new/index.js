...
class AppRouter extends React.Component {
    render() {
        return React.createElement(react_router_1.Router, {history: react_router_1.hashHistory}, React.createElement(react_router_1.Redirect, {from: "/", to: "message"}), React.createElement(react_router_1.Route, {path: "/msgset", getComponents: async('../msgset/index')}), React.createElement(react_router_1.Route, {path: "/reception", getComponents: async('../reception/index')}), React.createElement(react_router_1.Route, {path: "*", getComponents: async('../error/index')}));
    }
}
